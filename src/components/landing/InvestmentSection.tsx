        ...
        >
          <div className="space-y-6 mb-8">
            <div className="flex justify-between items-center border-b border-border/50 pb-4">
              <span className="text-secondary-foreground font-body">Implementation</span>
              <span className="font-heading text-foreground font-semibold">Starting at R$500</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-secondary-foreground font-body">Monthly Partnership</span>
              <span className="font-heading text-foreground font-semibold">From R$300</span>
            </div>
          </div>

          <p className="text-muted-foreground text-sm font-body mb-8">
            Customized according to business complexity and scope.
          </p>
